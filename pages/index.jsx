...
const Index = () => {
  return (
    <Layout noHeaderBg headerExtraClass={'two'} blackLogo pageName={'Home'}>
      ...
      <section className="gap">
        <div className="container">
          <div className="our-clients">
            <h4>See the clients we've delivered experiences for and how we did it.</h4>
          ...
          <div className="row">
            <div className="col-xl-4">
              ...
              <div className="why-choose-text">
                <h6>Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet vel dapibusid, mattis velnisi.</h6>
                <h5>Ideas</h5>
                <p>Morbi interdum mollis sapien. Sed ac risus. Phasellus lacinia, magna a ullamcorper laoreet.</p>
                <h5>Solution</h5>
                <p>Praesent dapibus, neque id cursus faucibus, tortor neque egestas auguae, eu vulputate magna eros eu erat.</p>
              </div>
            </div>
            <div className="col-xl-4 col-sm-6">
              ...
              <div className="choose-us-img">
                ...
                <div className="choose-us-img-text">
                  <i>
                    <svg enableBackground="new 0 0 124 124" height={512} viewBox="0 0 124 124" width={512} xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="col-xl-4 col-sm-6">
              <div className="choose-us-img">
                ...
                <div className="choose-us-img-text">
                  <i>
                    <svg enableBackground="new 0 0 64 64" height={512} viewBox="0 0 64 64" width={512} xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="choose-us-img">
                ...
                <div className="choose-us-img-text">
                  <i>
                    <svg enableBackground="new 0 0 48 48" height={512} viewBox="0 0 48 48" width={512} xmlns="http://www.w3.org/2000/svg">
                      <g>
      ...
      <section className="makes-us-different" style={{ backgroundColor: '#f2edf5' }}>
        <div className="container">
          ...
          <div className="row">
              ...
              <div className="makes-us-different-text">
                <i>
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="682.66669" height="682.66669" viewBox="0 0 682.66669 682.66669">
                    ...
                    <g mask="url(#custom)">
                      <g id="g2121" transform="matrix(1.3333333,0,0,-1.3333333,0,682.66667)">
                        <g id="g2123">
                          <g id="g2125" clipPath="url(#clipPath2129)">
                            ...
                            <g id="g2135" transform="translate(182.9702,151.3198)">
                              <path
                            ...
                            <g id="g2143" transform="translate(278.5801,156.9902)">
                              <path
            ...
            <div className="col-xl-4 col-lg-6 ">
              <div className="makes-us-different-text mb-0">
                ...
                <p>In nisi neque, aliquet vel, dapibus id, mattis vel, nisi. Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo.</p>
                <a href="services.html">Read More</a>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-xl-4">
              <div className="heading-boder">
                ...
                <a href="portfolio.html" className="themebtu full">
                  View More Works
                </a>
              </div>
            </div>
            <div className="col-xl-8">
              <Swiper {...studiesswiper} className="swiper-container studiesswiper">
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="case-studies-project">
                      ...
                      <p>Lorem ipsum dolor sit amet, consectetuer donec odio. Quisque volutpat mattis eros.</p>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="case-studies-project">
                      ...
                      <p>Quisque volutpat mattis eros. Nullam malesu adaerat ut turpis. </p>
                      <a href="portfolio-single-v1.html">View Project</a>
                    </div>
                  </SwiperSlide>
                </div>
          ...
          <div className="row">
            <div className="col-xl-5">
              <div className="heading">
                ...
                <h2> Web Development &amp; Web Design, Award Winning &amp; World-Class.</h2>
                <img alt="line" className="mb-4" src="assets/img/headingline.png" />
              </div>
              <div className="welcome-text">
                <h5>Result-Oriented Web Design</h5>
                <p>Morbi interdum mollis sapien. Sed ac risus. Phasellus lacinia, magna a ullamcorper laoreet, lectus arcu pulvinar facilisis. </p>
                <h5>SEO &amp; Digital Marketing</h5>
                <p>
                  Sed ac risus. Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet orci. Aenean dignissim pellentesque felis.
                </p>
            ...
            <div className="offset-xl-1 col-xl-6">
              <div className="welcome two">
                ...
                <img alt="img" className="img-welcome" src="assets/img/welcome-4.jpg" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="client-review">
                ...
                <p>" Suspendisse potenti. Sed egestas, ante etvulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. “</p>
              ...
              <div className="client-review mt-xl-5">
                ...
                <p>
                  " " Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittismi neque euismod dui, eu
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="client-review mb-xl-5">
                ...
                <p>
                  " Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu,
          ...
          <div className="row">
            <div className="col-xl-6">
              <div className="heading">
                ...
                <img alt="line" src="assets/img/headingline.png" />
                <p>
                  Nullam mollis. Ut justo. Suspendisse potenti. Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu
                  augue.{' '}
                </p>
              </div>
